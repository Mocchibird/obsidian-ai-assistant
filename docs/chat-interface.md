...
The most powerful mode, available to everyone. Combines Chat and Vault QA with an autonomous agent that can:
...
- [Agent Mode and Tools](agent-mode-and-tools.md) — What Agent mode can do
